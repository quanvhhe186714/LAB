...
Modify the AppBar title in main.dart:
...
Goal: Build a simple custom UI with widgets learned in class.
Steps
Replace default code in main.dart with:
...
What file acts as the entry point of a Flutter application?
Explain the difference between Hot Reload and Hot Restart.
How does runApp() build the widget tree?
Describe how Flutter’s architecture enables cross-platform development.
4. Expected Results
